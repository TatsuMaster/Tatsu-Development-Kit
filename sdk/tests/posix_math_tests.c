...
static void test_trunc()
{
    ...
    ASSERT_EQUALS("trunc: Checking, if trunc(-1.9) returns -1.0", trunc(-1.9), -1.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-1.8) returns -1.0", trunc(-1.8), -1.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-1.7) returns -1.0", trunc(-1.7), -1.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-1.6) returns -1.0", trunc(-1.6), -1.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-1.5) returns -1.0", trunc(-1.5), -1.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-1.4) returns -1.0", trunc(-1.4), -1.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-1.3) returns -1.0", trunc(-1.3), -1.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-1.2) returns -1.0", trunc(-1.2), -1.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-1.1) returns -1.0", trunc(-1.1), -1.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-1.0) returns -1.0", trunc(-1.0), -1.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-0.9) returns -0.0", trunc(-0.9), -0.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-0.8) returns -0.0", trunc(-0.8), -0.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-0.7) returns -0.0", trunc(-0.7), -0.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-0.6) returns -0.0", trunc(-0.6), -0.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-0.5) returns -0.0", trunc(-0.5), -0.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-0.4) returns -0.0", trunc(-0.4), -0.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-0.3) returns -0.0", trunc(-0.3), -0.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-0.2) returns -0.0", trunc(-0.2), -0.0);
    ASSERT_EQUALS("trunc: Checking, if trunc(-0.1) returns -0.0", trunc(-0.1), -0.0);
...
static void test_truncf()
{
    ...
    ASSERT_EQUALS("truncf: Checking, if truncf(-1.9f) returns -1.0f", truncf(-1.9f), -1.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-1.8f) returns -1.0f", truncf(-1.8f), -1.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-1.7f) returns -1.0f", truncf(-1.7f), -1.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-1.6f) returns -1.0f", truncf(-1.6f), -1.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-1.5f) returns -1.0f", truncf(-1.5f), -1.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-1.4f) returns -1.0f", truncf(-1.4f), -1.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-1.3f) returns -1.0f", truncf(-1.3f), -1.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-1.2f) returns -1.0f", truncf(-1.2f), -1.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-1.1f) returns -1.0f", truncf(-1.1f), -1.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-1.0f) returns -1.0f", truncf(-1.0f), -1.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-0.9f) returns -0.0f", truncf(-0.9f), -0.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-0.8f) returns -0.0f", truncf(-0.8f), -0.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-0.7f) returns -0.0f", truncf(-0.7f), -0.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-0.6f) returns -0.0f", truncf(-0.6f), -0.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-0.5f) returns -0.0f", truncf(-0.5f), -0.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-0.4f) returns -0.0f", truncf(-0.4f), -0.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-0.3f) returns -0.0f", truncf(-0.3f), -0.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-0.2f) returns -0.0f", truncf(-0.2f), -0.0f);
    ASSERT_EQUALS("truncf: Checking, if truncf(-0.1f) returns -0.0f", truncf(-0.1f), -0.0f);
...
static void test_truncl()
{
    ...
    ASSERT_EQUALS("truncl: Checking, if truncl(-1.9) returns -1.0", truncl(-1.9), -1.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-1.8) returns -1.0", truncl(-1.8), -1.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-1.7) returns -1.0", truncl(-1.7), -1.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-1.6) returns -1.0", truncl(-1.6), -1.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-1.5) returns -1.0", truncl(-1.5), -1.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-1.4) returns -1.0", truncl(-1.4), -1.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-1.3) returns -1.0", truncl(-1.3), -1.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-1.2) returns -1.0", truncl(-1.2), -1.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-1.1) returns -1.0", truncl(-1.1), -1.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-1.0) returns -1.0", truncl(-1.0), -1.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-0.9) returns -0.0", truncl(-0.9), -0.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-0.8) returns -0.0", truncl(-0.8), -0.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-0.7) returns -0.0", truncl(-0.7), -0.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-0.6) returns -0.0", truncl(-0.6), -0.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-0.5) returns -0.0", truncl(-0.5), -0.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-0.4) returns -0.0", truncl(-0.4), -0.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-0.3) returns -0.0", truncl(-0.3), -0.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-0.2) returns -0.0", truncl(-0.2), -0.0);
    ASSERT_EQUALS("truncl: Checking, if truncl(-0.1) returns -0.0", truncl(-0.1), -0.0);
